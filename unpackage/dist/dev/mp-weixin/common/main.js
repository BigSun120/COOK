...
/* 0 */
/*!*******************************************!*\
  !*** D:/woniu/fourstage/foodCook/main.js ***!
  \*******************************************/
...
__webpack_require__(/*! ./utils/request.js */ 19);
...
var _index2 = _interopRequireDefault(__webpack_require__(/*! @/api/index.js */ 17));
...
wx.__webpack_require_UNI_MP_PLUGIN__ = __webpack_require__;_axios.default.defaults.adapter = function (config) {return new Promise(function (resolve, reject) {var settle = __webpack_require__(/*! axios/lib/core/settle */ 45);var buildURL = __webpack_require__(/*! axios/lib/helpers/buildURL */ 29);uni.request({ method: config.method.toUpperCase(), url: config.baseURL + buildURL(config.url, config.params, config.paramsSerializer), header: config.headers, data: config.data, dataType: config.dataType, responseType: config.responseType, sslVerify: config.sslVerify, complete: function complete(response) {// console.log("执行完成：", response)
        response = { data: response.data, status: response.statusCode, errMsg: response.errMsg, header: response.header, config: config };settle(resolve, reject, response);} });});}; // import api from '@/api';
_vue.default.prototype.$api = _index2.default;_vue.default.use(_uviewUi.default);_vue.default.config.productionTip = false;_App.default.mpType = 'app';var app = new _vue.default(_objectSpread(_objectSpread({}, _App.default), {}, {
...
/* 6 */
/*!*******************************************!*\
  !*** D:/woniu/fourstage/foodCook/App.vue ***!
  \*******************************************/
/*! no static exports found */
...
/* 7 */
/*!********************************************************************!*\
  !*** D:/woniu/fourstage/foodCook/App.vue?vue&type=script&lang=js& ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
{
  onLaunch: function () {var _onLaunch = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var token, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
              console.log('App Launch');


              token = uni.getStorageSync('token');
              // console.log('Qaaa', token);
              if (token) {_context.next = 4;break;}return _context.abrupt("return");case 4:_context.next = 6;return (
...
/* 12 */
/*!*****************************************************************************!*\
  !*** D:/woniu/fourstage/foodCook/App.vue?vue&type=style&index=0&lang=scss& ***!
  \*****************************************************************************/
/*! no static exports found */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
